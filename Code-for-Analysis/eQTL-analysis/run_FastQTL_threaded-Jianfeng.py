...
def get_cmd(args, chunk):
    cmd = os.path.join(fastqtl_dir, 'bin', 'fastQTL.static')+' --vcf '+args.vcf+' --bed '+args.bed+' --window '+args.window \
...
parser.add_argument('--maf_threshold', default='0.01', help='Include only genotypes with minor allele frequency >=maf_threshold (default 0)')
...
fastqtl_dir = '/home/jianfeng_ke_student_uml_edu/fastqtl/'
